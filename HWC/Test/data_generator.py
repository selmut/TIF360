...
class DataGenerator:
    ...
    def generate_encoded_dataset(self, encoder):
        ...
        np.save('data/encoded/train_data.npy', np.array(train_data_downsampled))
        np.save('data/encoded/train_labels.npy', np.array(train_labels_downsampled))
        np.save('data/encoded/val_data.npy', np.array(val_data_downsampled))
        np.save('data/encoded/val_labels.npy', np.array(val_labels_downsampled))


encoder = load_model('models/enc_bn4')
gen = DataGenerator()
gen.generate_dataset()
gen.generate_encoded_dataset(encoder)
